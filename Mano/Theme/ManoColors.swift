...
extension Color {
    ...
    // MARK: - Note: Color accessors are auto-generated by Xcode from Asset Catalog
    // Access colors using: Color.forestGreen, Color.warmYellow, etc.
    // See GeneratedAssetSymbols.swift for auto-generated accessors
}
