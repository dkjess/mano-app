...
import { trackServerEvent, PerformanceTracker } from './observability/index.ts'
import {
...
// All system prompts and coaching strategy functions are now in ./algorithm/
...
// ============================================================================
// ALGORITHM FUNCTIONS - Now in ./algorithm/
// ============================================================================
// All prompt building, coaching strategy, and profile intelligence functions
// have been extracted to the algorithm/ directory for better organization.
// Import them from ./algorithm/index.ts at the top of this file.
